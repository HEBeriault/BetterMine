...
package net.mcreator.bettermine.network;
...
import net.mcreator.bettermine.procedures.CuttingtableButtonClickedProcedure;
...
public class CuttingboardguiButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		BettermineMod.addNetworkMessage(CuttingboardguiButtonMessage.class, CuttingboardguiButtonMessage::buffer, CuttingboardguiButtonMessage::new, CuttingboardguiButtonMessage::handler);
	}
}
